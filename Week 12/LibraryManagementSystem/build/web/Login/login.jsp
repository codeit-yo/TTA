...
<html lang="en">
    ...
    <body>
        ...
        <div id="header">
            <!-- Logo -->
            <h1>
                <a>Library <em>Management System</em></a>
            </h1>
        ...
        <div class="limiter">
            <div class="container-login100" style="background-image: url('images/library.jpg')">
                <div class="wrap-login100 p-t-30 p-b-50">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/check" class="login100-form validate-form p-b-33 p-t-5 p-r-15">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Select user type">
                            <select class="input100" name="usertype" id="usertype">
